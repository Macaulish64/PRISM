...
if __name__ == '__main__':
	# path="E:/test.csv"
	# infopath="E:\info.csv"
	g_list=[6,3,2,3/2,6/5,1] #PRISM中的划分粒度
	# print(type(result))
	print('done.')
	n = 10
	k = 2
	...
	path="../dataset/data_laplace_30-30-1M.csv"
	...
	for ii in range(len(g_list)):
		...
		print('MAE_PRISM for g=',g,' :', ERROR_PRISM / n)
		# print('done.')
		print('done.')
	for i in range(len(g_list)):
		print('MAE_PRISM for g=', 30//g_list[i], ' :', MEAN_ERROR_PRISM[i])
